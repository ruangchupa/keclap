...
export const SHARE_FAILURE_TEXT =
  'Teu bisa ngabagikeun hasil. Coba pastikeun keur make HTTPS atau pastikeun make browser nu rada canggih.'
export const SHARE_TWITTER_TEXT = 'Tweet'
export const MIGRATE_BUTTON_TEXT = 'Transper'
export const MIGRATE_DESCRIPTION_TEXT =
  'Pencet tombol ieu keur mindahkeun statistik didinya ka device anyar.'
...
export const DATEPICKER_TITLE = 'Pilih tanggal nu geus kaliwat'
export const DATEPICKER_CHOOSE_TEXT = 'Pilih'
export const DATEPICKER_TODAY_TEXT = 'poe ieu'
export const ARCHIVE_GAMEDATE_TEXT = 'Tanggal game'
